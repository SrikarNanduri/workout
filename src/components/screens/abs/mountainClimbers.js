...
class mountainClimbers extends Component {
  render(){
    return(
      <ScrollView>
      <Card>
        ...
        <CardSection>
          <Text1 >3 sets of Mountain Climbers</Text1>
        </CardSection>
          ...
          <CardSection>
           ...
           <CardSection>
          <Text2 >Set 2 : 20 Repetitions {"\n"}    (REST : 30-50 secs)</Text2>
        </CardSection>

          <CardSection>
          <Text2>Set 3 : 20 Repetitions {"\n"}     (REST : 1-2 mins)</Text2>
        </CardSection>
            </Card>
